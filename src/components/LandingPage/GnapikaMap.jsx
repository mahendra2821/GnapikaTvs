  ...
  return (
    <section className="py-12 px-6 text-center">
      <h2 className="text-3xl font-bold text-blue-900 mb-4">
        Ways to connect with <span className="text-black">Gnapika TVS</span>
      </h2>

      <p className="text-gray-600 max-w-3xl mx-auto mb-6">
        We would love to hear from you! If you have any queries or need additional information,  
        please contact your nearest TVS showroom. You can also test ride or book a service appointment.
      </p>
